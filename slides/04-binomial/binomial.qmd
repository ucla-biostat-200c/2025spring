...
![](main-qimg-68daeded849b4a3a049eeb78822a68bb.png)
...
\end{eqnarray*}
**Exercise**: Verify that the log-likilihood $\ell_i$ of a binomial proportion $Y_i$, where $m_i Y_i \sim \text{Bin}(m_i, p_i)$, satisfies  
\begin{eqnarray*}
