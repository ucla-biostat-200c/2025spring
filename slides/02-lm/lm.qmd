...
The `gavote` data contains the voting data of [Georgia (GA) in the 2000 presidential election](https://en.wikipedia.org/wiki/2000_United_States_presidential_election_in_Georgia). It is available as a dataframe. 
```{r}
